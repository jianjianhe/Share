...
var password_warn = $('#password_warn');
var password1_warn = $('#password1_warn');
...
$('#password1').focus(function () {
    password1_warn.css("display", "none");
});
...
var password1_null = $("#password1_null");
...
registerFormBtn.click(function () {
    ...
    var password1_value = password1.val().length;
    ...
    if (phone_value !== 0
        ...
        && password_value !== 0
        && password1_value !== 0
        && (radio_input[0].checked || radio_input[1].checked)) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data['status'] == 902) {
                    ...
                    password1_warn.css("display", "block")
